  ...
  return (
    <>
      ...
      >
        ...
        <div 
          className={`fixed inset-0 bg-white dark:bg-slate-950 z-[55] md:hidden flex flex-col transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] ${
            isOpen 
                  ...
                  >
                    {link.name === 'Products' ? (
                      ...
                      <Link
                        to={link.path}
                        className={`group flex items-center justify-between py-3 border-b border-gray-50 dark:border-slate-800 ${
                          isActive(link.path) ? 'text-blue-600 dark:text-blue-400' : 'text-slate-900 dark:text-white'
                        }`}
                      >
