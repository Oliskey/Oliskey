...
const Services: React.FC = () => {
   ...
   return (
      <div className="pt-28 pb-24 bg-gray-50 dark:bg-slate-950 transition-colors duration-300">
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-24">
               {services.map((service, index) => (
                  <div key={index} className="bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-slate-800 group">
            ...
            <div className="mb-20">
               <div className="bg-white dark:bg-slate-900 rounded-3xl p-8 lg:p-12 shadow-xl border border-gray-100 dark:border-slate-800 overflow-hidden relative transition-colors">
                  {/* Adjusted blur opacities for dark mode */}
                  <div className="absolute top-0 right-0 w-96 h-96 bg-indigo-50 dark:bg-indigo-900/10 rounded-full mix-blend-multiply dark:mix-blend-normal filter blur-3xl opacity-70 animate-blob"></div>
                  <div className="absolute top-0 -left-4 w-72 h-72 bg-purple-50 dark:bg-purple-900/10 rounded-full mix-blend-multiply dark:mix-blend-normal filter blur-3xl opacity-70 animate-blob animation-delay-2000"></div>

                  <div className="relative z-10 flex flex-col lg:flex-row items-center gap-12">
                     <div className="lg:w-1/2">
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 text-xs font-bold uppercase tracking-wider mb-6">
                        ...
                        <div className="space-y-4 mb-8">
                           ...
                           <div className="flex items-start gap-4">
                              ...
                              <div>
                                 <h4 className="font-bold text-slate-900 dark:text-white">Custom SaaS Development</h4>
                                 <p className="text-sm text-slate-500 dark:text-slate-400">We can build your startup's MVP or your enterprise's internal tool.</p>
                              </div>
                           </div>
                        </div>

                        <a href="https://school-app-one-fawn.vercel.app/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg font-bold transition-colors shadow-lg shadow-indigo-500/20">
            ...
            {/* CTA */}
            <div className="bg-slate-900 dark:bg-slate-900 rounded-3xl p-12 text-center text-white shadow-2xl relative overflow-hidden">
